...
import com.example.digikala1.data.model.category.CategoryItem
...
fun SubCategorySection(
    ...
    if (loading) {
        ...
        Column(
            ...
            CategoryItem(title = stringResource(id = R.string.digital_goods), subList = digitalList)
            CategoryItem(title = stringResource(id = R.string.mobile), subList = mobileList)
            CategoryItem(
