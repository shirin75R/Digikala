package com.example.digikala1.util
...
object Constants {
    ...
    const val API_KEY = com.example.digikala1.BuildConfig.X_API_KEY
    const val KEY = com.example.digikala1.BuildConfig.KEY
    const val IV = com.example.digikala1.BuildConfig.IV
